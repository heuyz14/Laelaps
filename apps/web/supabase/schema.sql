-- Consolidated schema snapshot as of 2026-08-27.
--
-- This file is for provisioning a fresh database. Existing environments
-- should continue using the versioned migrations in migrations/ so Supabase
