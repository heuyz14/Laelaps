...
type EmailPasswordAction = (formData: FormData) => void | Promise<void>;

export function EmailPasswordPanelClient({
  authMessage,
  signInAction,
  signUpAction,
}: {
  authMessage: AuthMessage | null;
  signInAction: EmailPasswordAction;
  signUpAction: EmailPasswordAction;
}) {
